...
const CACHE_NAME = 'rw018-offline-v5';
...
const STATIC_ASSETS = [
  '/rw018app/',
  '/rw018app/index.html',
  '/rw018app/manifest.json',
  '/rw018app/logo-rw-018.jpg',
  '/rw018app/logo-rw-018.png',
  '/rw018app/pwa-192x192.png',
  '/rw018app/pwa-512x512.png',
  '/rw018app/pwa-maskable-512x512.png',
  '/rw018app/apple-touch-icon.png',
  '/rw018app/favicon.ico',
  '/rw018app/peta-satelit-rw018.jpg'
];
      ...
      fetch(req)
        .then((networkResponse) => {
          if (networkResponse && networkResponse.status === 200) {
            ...
            caches.open(CACHE_NAME).then((cache) => {
              cache.put('/rw018app/index.html', clone);
            });
          }
        ...
        .catch(async () => {
          ...
          const cachedIndex = await caches.match('/rw018app/index.html');
          if (cachedIndex) return cachedIndex;
          const cachedRoot = await caches.match('/rw018app/');
