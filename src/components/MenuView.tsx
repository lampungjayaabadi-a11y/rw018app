    ...
    <div className="space-y-4 p-4 pb-16 max-w-5xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-emerald-800 to-teal-900 dark:from-slate-900 dark:to-emerald-950 text-white p-5 rounded-3xl shadow-sm border border-emerald-700/50 dark:border-slate-800 relative overflow-hidden transition-colors duration-200 space-y-4">
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="w-full sm:w-auto grid grid-cols-1 sm:grid-cols-2 gap-2 self-stretch sm:self-center">
            {onOpenAndroidModal && (
              <button
                id="btn-menu-open-android"
                onClick={onOpenAndroidModal}
                className="w-full px-3 py-2 bg-amber-400 hover:bg-amber-300 text-emerald-950 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm active:scale-95 transition-all cursor-pointer"
              >
                <Smartphone className="w-3.5 h-3.5 text-emerald-950 shrink-0" />
                <span className="truncate">Jadikan APK Android</span>
              </button>
            )}
            ...
            {isUserSuperAdmin(currentUser) && (
              <button
                ...
                className="w-full px-3 py-2 bg-white dark:bg-slate-800 text-emerald-900 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-slate-700 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm active:scale-95 transition-all cursor-pointer border border-emerald-100 dark:border-slate-700"
              >
