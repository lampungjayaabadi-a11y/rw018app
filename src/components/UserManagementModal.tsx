...
export const UserManagementModal: React.FC<UserManagementModalProps> = ({
  ...
  const handleOpenFaceRegistration = (targetUser?: AppUser) => {
    ...
    const draftUser: AppUser = {
      ...
      password: formData.password || '@Ayahibu99',
  ...
  const handleSaveForm = (e: React.FormEvent) => {
    ...
    const userToSave: AppUser = {
      ...
      password: finalRole === 'warga' ? '' : (formData.password || '@Ayahibu99'),
      role: finalRole,
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400">
                        Opsi login cepat tanpa ketik, otomatis divalidasi dengan kode password & wewenang hak akses role.
                      </p>
                    </div>
                  </div>
