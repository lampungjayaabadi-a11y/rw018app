            ...
            <div className="space-y-4">
              ...
              <div className="text-center p-5 bg-slate-50 rounded-2xl border border-slate-200 space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 bg-gradient-to-r from-emerald-700 to-teal-700 hover:from-emerald-800 hover:to-teal-800 text-white rounded-xl font-bold text-sm shadow-md flex items-center justify-center gap-2 active:scale-98 transition-all cursor-pointer"
                >
                ...
                {showDirectGuide && (
                  <div className="p-3 bg-amber-50 rounded-xl border border-amber-300 text-amber-900 text-left text-xs animate-in fade-in duration-200">
                    <p className="font-bold flex items-center gap-1.5 text-amber-950">
                      <HelpCircle className="w-4 h-4 text-amber-600 shrink-0" />
                      Langkah Pasang di Google Chrome HP:
                    </p>
                    <p className="mt-1 text-[11px] leading-relaxed text-amber-900">
                      1. Buka link ini di Google Chrome HP.<br />
                      2. Tekan menu titik tiga <strong>(⋮)</strong> di kanan atas.<br />
                      3. Pilih <strong>"Instal Aplikasi"</strong> atau <strong>"Tambahkan ke Layar Utama"</strong>.
                    </p>
                  </div>
                )}
              </div>
