...
export const KasReportModal: React.FC<KasReportModalProps> = ({
  ...
  const handleDownloadPdf = async () => {
    ...
    const filename = `Laporan-Kas-RW018-${dateStr}.pdf`;

    await downloadElementAsPdf('kas-report-print-sheet', {
      filename,
      orientation: 'landscape',
      title: 'Laporan Pertanggungjawaban Kas RW 018',
      author: 'Pengurus RW 018 Kampung Banten',
      subject: 'Laporan Arus Kas dan Keuangan RW 018',
        ...
        <div className="p-3.5 sm:p-5 bg-gradient-to-r from-slate-900 via-teal-950 to-slate-900 text-white flex flex-col sm:flex-row sm:items-center justify-between gap-3 shrink-0 print:hidden border-b border-slate-800">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              type="button"
              onClick={onClose}
              className="p-1.5 rounded-xl bg-white/10 hover:bg-white/20 text-slate-300 hover:text-white transition-colors cursor-pointer active:scale-95"
              title="Tutup Laporan"
            >
              <X className="w-5 h-5" />
            </button>
        ...
        <div className="bg-slate-100 border-t border-slate-200 px-5 py-3 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0 print:hidden">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end flex-wrap">
            ...
            <button
              ...
              title="Download Hasil Cetak Menjadi PDF A4"
            >
            ...
            <button
              ...
              title="Cetak Laporan ke Printer Fisik atau Simpan sebagai PDF"
            >
